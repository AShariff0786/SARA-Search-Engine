...
function downloadFiles(type) {
  ...
  if (type == "json") {
    ...
    for(var j = 0; j <selected.length; j++) {
      ...
      var title = document.getElementById("title_" + j).innerHTML;
      var url = document.getElementById("url_" + j).innerHTML;
      var desc = document.getElementById("desc_" + j).innerHTML;
